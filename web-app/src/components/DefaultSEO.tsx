...
export default function DefaultSEO() {
  return (
    <Helmet>
      ...
      <meta name="description" content="CoachAcadem is a leading online tutoring platform that provides personalized and effective learning solutions for students of all ages and levels." />
      ...
      <meta property="og:description" content="CoachAcadem is a leading online tutoring platform that provides personalized and effective learning solutions for students of all ages and levels." />
      ...
      <meta name="twitter:description" content="CoachAcadem is a leading online tutoring platform that provides personalized and effective learning solutions for students of all ages and levels." />
