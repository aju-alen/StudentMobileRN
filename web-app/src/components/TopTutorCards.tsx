...
/**
 * Featured tutors are selected by: highest rated, strong review history,
 * recent activity, and complete profile.
 */
const featuredTutors: FeaturedTutor[] = [
  {
    ...
    qualification: 'MSc Mathematics, University of Oxford',
    subjects: ['Mathematics', 'Further Mathematics'],
    curricula: ['IGCSE', 'A-Level', 'IB'],
    rating: 4.9,
    reviewCount: 128,
    yearsExperience: 8,
    profileHref: '#tutor-sarah-hassan',
  },
  {
    id: 'james-okafor',
    name: 'James Okafor',
    ...
    reviewCount: 96,
    yearsExperience: 6,
    profileHref: '#tutor-james-okafor',
  },
  {
    id: 'fatima-al-zaabi',
  ...
  <article className="flex h-full flex-col rounded-xl sm:rounded-2xl border border-gray-200 bg-white p-5 sm:p-6 shadow-sm w-full min-w-0">
    <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
      ...
      <div className="min-w-0 flex-1">
        <h3 className="text-lg sm:text-xl font-bold text-gray-900 truncate">{tutor.name}</h3>
    ...
    <div className="space-y-2.5 sm:space-y-3 flex-grow mb-4 sm:mb-6">
      ...
      <p className="text-sm text-gray-600">
        <span className="font-semibold text-gray-700">{tutor.yearsExperience} years</span>{' '}
        teaching experience
      </p>
    </div>
