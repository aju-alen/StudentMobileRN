...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="pt-32 pb-20 md:pt-40 md:pb-32 px-4 md:px-32 relative overflow-hidden bg-gradient-to-b from-indigo-50 to-white"
    >
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2  gap-12 items-center">
          {/* Left Column - Content */}
          <div className="text-left">
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-[900] mb-6 lg:leading-tight md:mt-10   ">
