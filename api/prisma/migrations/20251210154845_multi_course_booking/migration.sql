...
CREATE TABLE `CourseEnrollment` (
    ...
    INDEX `CourseEnrollment_subjectId_enrollmentStatus_idx`(`subjectId`, `enrollmentStatus`),
...
-- CreateIndex
CREATE INDEX `Subject_scheduledDateTime_idx` ON `Subject`(`scheduledDateTime`);
