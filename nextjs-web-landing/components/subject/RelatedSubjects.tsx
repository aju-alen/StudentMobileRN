import type { RelatedSubject } from '@/lib/subjects/types';

type RelatedSubjectsProps = {
  title: string;
  lead?: string;
...
}: RelatedSubjectsProps) {
  if (subjects.length === 0) {
    return null;
  }

  return (
    <section className={`home-section home-section-spacing ${className}`}>
